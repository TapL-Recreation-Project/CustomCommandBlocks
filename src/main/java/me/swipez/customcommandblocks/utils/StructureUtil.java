package me.swipez.customcommandblocks.utils;

import me.swipez.customcommandblocks.CustomCommandBlocks;
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                for (int i = 0; i < chest.getInventory().getSize(); i++){
                    chest.getBlockInventory().addItem(new ItemStack(Material.BAKED_POTATO, 64));
                }
            }
        }.runTaskLater(CustomCommandBlocks.plugin, 1);
    }
